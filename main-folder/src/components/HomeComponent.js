...
function Home(props) {
    return ( <div className="our-story-container" dir="ltr">
										...
										<li data-uia="field-email+wrapper" className="nfFormSpace field-email">
											<div data-uia="field-email+container" className="nfInput nfInputResponsive">
												<div className="nfInputPlacement">
														<input type="email" placeholder="Email Address" data-uia="field-email" name="email" className="nfTextField" id="id_email_hero_fuji" value="" tabindex="0" autoComplete="email" maxLength="50" minLength="5" dir=""/>
												</div>
											</div>
										</li>
									</ul>
