...
export default function MainTvImage(props) {
  const slides = [
    { id: props.tvshowid, image: props.image, title: props.title, text: props.text },
    { id: props.tvshowid1, image: props.image1, title: props.title1, text: props.text1 },
    { id: props.tvshowid2, image: props.image2, title: props.title2, text: props.text2 },
  ...
  return (
    <section className="relative h-52 overflow-hidden sm:h-64 md:h-80">
      <Link to={`/tv/${slide.id}`} className="block h-full cursor-pointer">
