export function ActionButton({ active, onClick, icon: Icon, label, badge, compactLabel, subLabel }) {
  return (
    <button
      type="button"
      onClick={onClick}
      ...
      aria-pressed={active}
      className={`flex flex-col items-center justify-center gap-1 rounded-xl border px-2 py-3 transition-all duration-300 cursor-pointer min-h-[72px] md:min-h-[44px] md:flex-row md:gap-2 md:px-4 md:py-2 ${
        active
